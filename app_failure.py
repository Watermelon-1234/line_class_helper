...
# line_bot_api = LineBotApi(os.environ['CHANNEL_ACCESS_TOKEN']) #deprecated and replaced by below
...
if __name__ == "__main__":
    ...
    serve(app, host="0.0.0.0", port=port)# use serve to replace app.run for:
